...
const EditFeesModal = ({
  ...
  useEffect(() => {
    if (editFees) {
      setFormData({
        name: editFees.name,
        rollNo: editFees.rollNo,
        class: editFees.class,
        amount: editFees.amount,
        date: editFees.date,
        status: editFees.status,
      });
    }
  }, [editFees]);
      ...
      <div className="w-full max-w-2xl bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/40 p-6 md:p-8">
        ...
        >
          ...
          <input
            ...
            className="p-3 rounded-2xl border border-slate-300 outline-none focus:ring-2 focus:ring-blue-400"
            required
          />
          ...
          <div className="md:col-span-2 flex justify-end gap-4 mt-4">
            ...
            <button
              type="submit"
              className="px-6 py-3 rounded-2xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:scale-105 transition"
            >
              Update Fees
            </button>
